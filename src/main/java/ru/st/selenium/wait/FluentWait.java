...
/**
 * An implementation of the {@link org.openqa.selenium.support.ui.Wait} interface that may have its timeout and polling interval
...
public class FluentWait<T> implements Wait<T> {
  ...
  protected FluentWait<T> cleanIgnoreList() {
